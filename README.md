...
2. Auth (OTP + biometric + passkey groundwork)
3. Banking (offline-first ledger, idempotent transfer, Drift)
4. Stock (multiplexed WebSocket ticker, Bloc)
5. Insurance, Consumer, Lifestyle
6. Native platform channel (one written by hand, not a plugin)
7. CI (GitHub Actions: analyze + test on every push)
